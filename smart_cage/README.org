...
* Command Line Examples
  ...
  #+BEGIN_SRC sh
    ...
    ros2 topic pub -1 /create_session smart_cage_msgs/Session "{mouse_name: HC34, start_time_hour: 9, start_time_minute: 0, threshold: 0.25, duration: 12, latch_mode: false, require_both_head_bar_sensors: true}"
  #+END_SRC
